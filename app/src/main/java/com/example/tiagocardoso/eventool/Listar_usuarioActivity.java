...
public class Listar_usuarioActivity extends AppCompatActivity {
    ...
    private class DownloadFromMyAPI extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            List<Usuario> clubes = Util.convertJSONtoUsuario(s);
            if(clubes != null){
                ArrayAdapter<Usuario> usuarioAdapter = new UsuarioAdapter(Listar_usuarioActivity.this,R.layout.usuario_item,clubes);
